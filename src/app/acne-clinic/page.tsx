  ...
  return (
    <>
      <HeroSection
        ...
        bgImage="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=1920&q=80"
      />
      ...
      <section className="py-20 px-6 bg-brand-cream">
        <div className="mx-auto max-w-4xl">
          <h3 className="font-serif text-3xl italic text-center">McKenna</h3>
          <p className="text-sm text-center text-brand-warm-gray mt-1">Acne Client &ndash; &ldquo;Wedding Day Ready&rdquo;</p>
          <p className="mt-8 text-brand-charcoal/70 leading-relaxed text-center">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="mx-auto max-w-5xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {[
            { title: "Supplements", desc: "Learn more about a way to support your skin health from the inside out.", href: "https://shop.refined.skin" },
            { title: "Skincare Tools", desc: "Shop our favorite skincare tools and technology.", href: "https://shop.refined.skin" },
            { title: "Skincare", desc: "Optimize your skin health with a simple and customized skincare regimen.", href: "https://shop.refined.skin" },
            { title: "Ingredient Checker", desc: "Check to see if any of your products have pore-clogging ingredients.", href: "/ingredient-checker" },
          ].map((item) => (
            <a
              key={item.title}
              href={item.href}
              className="group text-center p-6 border border-brand-charcoal/10 rounded-sm hover:border-brand-beige transition-colors"
            >
